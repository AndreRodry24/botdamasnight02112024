...
export const monitorVideos = async (conn, message) => {
    ...
    if (userVideoData[participant].count === videoLimit) {
        const mentionMessage = `@${participant.split('@')[0]}, você enviou 4 vídeos. Se mandar o *quinto*, *você será removido do grupo*, pois o limite é somente *4 por dia*. *Leia as regras.*`;
